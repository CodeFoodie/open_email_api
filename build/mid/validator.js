...
var sendmail = [(0, _expressValidator.body)('receiver', 'Please provide a valid receiver email').isEmail(), (0, _expressValidator.body)('subject', 'Please provide a reasonable subject').isLength({
  min: 5
